...
class CustomMobileTextField extends StatefulWidget {
  ...
  const CustomMobileTextField({Key? key, required this.ctl, required this.hint, required this.label, this.pwd= false, this.fillColor = const Color(0xFFFFFFFF) }) : super(key: key);
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(color: flagFocused? const Color(0xFF040415) : const Color(0xFF040415).withOpacity(0.1))
          ),
          child: Row(
            children:[
              SizedBox(
        ...
        Positioned(
          ...
          child: Container(
            ...
            color: Colors.white,
            child: Text(widget.label, style: TextStyle(fontSize: fSize(12), fontWeight: FontWeight.w400, color: const Color(0xFFBFBFBF))),
          ),
        )
      ],
    );
