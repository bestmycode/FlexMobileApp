...
class PhysicalTeamHeader extends StatefulWidget {
  final activeType;
  final sortType;
  final subSortType;
  final sortArr;
  ...
  @override
  PhysicalTeamHeaderState createState() => PhysicalTeamHeaderState();
}

class PhysicalTeamHeaderState extends State<PhysicalTeamHeader> {
  hScale(double scale) {
