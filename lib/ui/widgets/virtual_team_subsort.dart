...
class VirtualTeamSubSort extends StatefulWidget {
  final sortType;
  final subSortType;
  final sortArr;
  final handleSubSortType;
  const VirtualTeamSubSort(
      {Key? key,
      this.sortType,
      this.subSortType,
      this.sortArr,
  ...
  @override
  VirtualTeamSubSortState createState() => VirtualTeamSubSortState();
}

class VirtualTeamSubSortState extends State<VirtualTeamSubSort> {
  hScale(double scale) {
