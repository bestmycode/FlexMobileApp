...
class TwoStepFinalScreenState extends State<TwoStepFinalScreen> {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              finalStepSubTitle('We have sent you an sms, please click on the link\nand complete your ID verification', 0xff515151, 'normal'),
              ...
              finalStepBoldTitle('Once you have completed the verification\nprocess, click Continue', 0xff1A2831),
              const CustomSpacer(size: 38),
              continueButton(),
  ...
  Widget verifyField() {
    return Container(
      ...
      child: Column(
        children: [
          finalStepBoldTitle('Upon opening the link, follow the\ninstructions provided below on your\nmobile device:', 0xff1A2831),
          const CustomSpacer(size: 34),
          finalStepCardIcon(),
