...
class CompleteNewSubsidiaryState extends State<CompleteNewSubsidiary> {
  ...
  Widget cardValanceField() {
    return Container(
        ...
        child: Column(
            children: [
              moneyValue('Total Funds', '0.00', 20.0, FontWeight.bold, const Color(0xff30E7A9)),
              const CustomSpacer(size: 8,),
              moneyValue('Credit Line', '-', 16.0, FontWeight.w600, const Color(0xffADD2C8)),
              const CustomSpacer(size: 8,),
              moneyValue('Business Account', '0.00', 16.0, FontWeight.w600, const Color(0xffADD2C8)),
            ]
        )
    );
  }
  ...
  Widget cardTypeField() {
    return Opacity(
        ...
        child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              cardTypeImage('assets/physical_card.png', 'Physical Cards', 0, 'physical'),
              cardTypeImage('assets/virtual_card.png', 'Virtual Cards', 0, 'virtual'),
            ]
        )
    );
  }
  ...
  Widget emptyTransactionField() {
    return Container(
      ...
      child: Column(
        children: [
          Text('You have no transactions', style: TextStyle(fontSize: fSize(12), fontWeight: FontWeight.w600, color: const Color(0xFF70828D))),
          const CustomSpacer(size: 23),
          Image.asset('assets/empty_transaction.png', fit:BoxFit.contain, width: wScale(159))
        ],
      ),
    );
  }
