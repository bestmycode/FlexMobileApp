...
import 'package:co/ui/widgets/virtual_team_subsort.dart';
...
class VirtualTeamCardsMain extends StatefulWidget {
  final transactions;
  final sortType;
  final sortArr;
  final showSortModal;
  final showSubSortModal;
  final handleSortModal;
  final handleCardType;
  final activeType;
  final handleCardDetail;
  final handleSortType;
  final handleSubSortModal;
  const VirtualTeamCardsMain({
    Key? key,
    this.transactions,
    this.sortType,
    this.sortArr,
    this.showSortModal,
    this.showSubSortModal,
    this.handleSortModal,
    this.handleCardType,
    this.activeType,
    this.handleCardDetail,
    this.handleSortType,
    this.handleSubSortModal,
  }) : super(key: key);

  @override
  VirtualTeamCardsMainState createState() => VirtualTeamCardsMainState();
}

class VirtualTeamCardsMainState extends State<VirtualTeamCardsMain> {
  hScale(double scale) {
