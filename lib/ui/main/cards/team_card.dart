import 'package:co/ui/main/cards/personal_card.dart';
...
class TeamCardsState extends State<TeamCards> {
  ...
  handleCardDetail(data) {
    Navigator.of(context).push(
      CupertinoPageRoute(builder: (context) => const PersonalCard()),
    );
  }
    ...
    return TextButton(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(fontSize: fSize(14), color: const Color(0xff70828D)),
        ),
      ),
    );
  }
